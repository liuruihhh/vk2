...
#pragma endregion class_member
	...
	void createTextureImage() {
		...
		createImage(static_cast<uint32_t>(texW), static_cast<uint32_t>(texH), mipLevels, VK_FORMAT_R8G8B8A8_SRGB
	...
	void createImage(uint32_t width, uint32_t hight, uint32_t mipLevels, VkFormat format, VkImageTiling tiling,
